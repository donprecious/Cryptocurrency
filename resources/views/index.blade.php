...
<section id="home" class="home">
    ...
    <div class="owl-carousel home__slider">
        <!-- slide -->
        <div class="item" data-bg="{{ asset('img/home/slide.jpg')}}"></div>
        <!-- end slide -->

        <!-- slide -->
        <div class="item" data-bg="{{ asset('img/home/slide2.jpg')}}"></div>
        <!-- end slide -->

        <!-- slide -->
        <div class="item" data-bg="{{ asset('img/home/slide3.jpg')}}"></div>
        <!-- end slide -->
    </div>
    <!-- end home slider -->
...
<!-- counter -->
<div class="section counter section--bg" data-bg="{{ asset('img/section-bg/section-bg3.jpg')}}">
    <div class="container">
        <div class="row">
...
<!-- video -->
<section class="section video section--bg" data-bg="{{ asset('img/section-bg/section-bg2.jpg')}}">
    <div class="container">
        <div class="row">
...
<section class="section">
    ...
    <div class="owl-carousel team team--grey">
        ...
        <div class="item">
            <img class="team__img" src="{{asset('img/team/member2.png')}}" alt="">
            <div class="team__meta">
                <p>Jonathan</p>
                <span>Founder</span>
                <ul class="clearfix">
        ...
        <div class="item">
            <img class="team__img" src="{{asset('img/team/member4.png')}}" alt="">
            <div class="team__meta">
                <p>John</p>
        ...
        <div class="item">
            <img class="team__img" src="{{asset('img/team/member5.png')}}" alt="">
            <div class="team__meta">
                <p>Emily</p>
                <span>Marketer</span>
                <ul class="clearfix">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="owl-carousel partners__slider">
                    ...
                    <div class="item">
                        <a href="#">
                            <img src="{{asset('img/partners/activeden-light-background.png')}}" alt="">
                        </a>
                    </div>
                    <!-- end slider item -->
                    ...
                    <div class="item">
                        <a href="#">
                            <img src="{{asset('img/partners/audiojungle-light-background.png')}}" alt="">
                        </a>
                    </div>
                    <!-- end slider item -->
                    ...
                    <div class="item">
                        <a href="#">
                            <img src="{{asset('img/partners/codecanyon-light-background.png')}}" alt="">
                        </a>
                    </div>
                    <!-- end slider item -->
                    ...
                    <div class="item">
                        <a href="#">
                            <img src="{{asset('img/partners/graphicriver-light-background.png')}}" alt="">
                        </a>
                    </div>
                    <!-- end slider item -->
                    ...
                    <div class="item">
                        <a href="#">
                            <img src="{{asset('img/partners/photodune-light-background.png')}}" alt="">
                        </a>
                    </div>
                    <!-- end slider item -->
                    ...
                    <div class="item">
                        <a href="#">
                            <img src="{{asset('img/partners/themeforest-light-background.png')}}" alt="">
                        </a>
                    </div>
                    <!-- end slider item -->
                    ...
                    <div class="item">
                        <a href="#">
                            <img src="{{asset('img/partners/videohive-light-background.png')}}" alt="">
                        </a>
                    </div>
                    <!-- end slider item -->
                    ...
                    <div class="item">
                        <a href="#">
                            <img src="{{asset('img/partners/3docean-light-background.png')}}" alt="">
                        </a>
                    </div>
                    <!-- end slider item -->
                </div>
...
<div id="signup" class="mfp-hide modal">
    ...
    <form class="form form--modal" action="{{ route('register') }}">

        <input  id="email" type="email" class="form__input {{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Email" name="email" value="{{ old('email') }}" required>
        @if ($errors->has('email'))
        ...
        <input type="password" id="password" class="form__input {{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="Password" name="password" required>
