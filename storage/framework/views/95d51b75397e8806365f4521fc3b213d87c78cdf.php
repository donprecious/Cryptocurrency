...
<head>
    ...
    <!-- Fav Icon -->
    <link rel="shortcut icon" href="<?php echo e(asset('tokenWiz/images/favicon.png')); ?>">
    <!-- Site Title  -->
    <title>Cryptocurrency </title>
    <!-- Vendor Bundle CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('tokenWiz/assets/css/vendor.bundlea5f5.css?ver=102')); ?>">
...
<body class="page-user">
            ...
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a class="topbar-logo" href="index.html">
                        <img src="<?php echo e(asset('tokenWiz/images/logo-light2x.png')); ?>" srcset="<?php echo e(asset('tokenWiz/images/logo-light2x.png 2x')); ?>" alt="logo">
                    </a>
                    <ul class="topbar-nav">
                        <li class="topbar-nav-item relative">
                            <span class="user-welcome d-none d-lg-inline-block">Welcome!  <?php echo e(Auth::user()->email); ?></span>
                            ...
                            <div class="toggle-class dropdown-content dropdown-content-right dropdown-arrow-right user-dropdown">
                                ...
                                <ul class="user-links">
                                    <li>
                                        <a href="<?php echo e(asset('tokenWiz/profile.html')); ?>">
            ...
            <div class="container">
                <div class="navbar-innr">
                    <ul class="navbar-menu">
                        <li>
                            <a href="<?php echo e(asset('tokenWiz/index-2.html')); ?>">
                                <em class="ikon ikon-dashboard"></em> Dashboard</a>
                        </li>
                        <li>
                            <a href="<?php echo e(asset('tokenWiz/buy-token.html')); ?>">
                                <em class="ikon ikon-coins"></em> Buy Tokens</a>
                        </li>
                        <li>
                            <a href="<?php echo e(asset('tokenWiz/ico-distribution.html')); ?>">
                                <em class="ikon ikon-distribution"></em> ICO Distribution</a>
                        </li>
                        <li>
                            <a href="<?php echo e(asset('tokenWiz/transactions.html')); ?>">
                        ...
                        <li class="has-dropdown page-links-all">
                            ...
                            <ul class="navbar-dropdown">
                                <li class="has-dropdown">
                                    ...
                                    <ul class="navbar-dropdown">
                                        <li>
                                            <a href="<?php echo e(asset('tokenWiz/form-elements.html')); ?>">Form Elements</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(asset('tokenWiz/form-layout.html')); ?>">Form Layout</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(asset('tokenWiz/buttons.html')); ?>">Button</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(asset('tokenWiz/badges.html')); ?>">Badge</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(asset('tokenWiz/tabs.html')); ?>">Tabs</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(asset('tokenWiz/accordions.html')); ?>">Accordions</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(asset('tokenWiz/modals.html')); ?>">Modals</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(asset('tokenWiz/alerts.html')); ?>">Alerts</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(asset('tokenWiz/alert-toastr.html')); ?>">Toastr Alerts</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="has-dropdown">
    ...
    <script src="<?php echo e(asset('tokenWiz/assets/js/jquery.bundlea5f5.js?ver=102')); ?>"></script>
